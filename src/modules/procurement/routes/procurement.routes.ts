...
router.get('/suppliers', authenticate, validate(listSuppliersSchema), procurementController.listSuppliers);
router.post('/suppliers', authenticate, validate(createSupplierSchema), procurementController.createSupplier);

router.get('/purchase-orders', authenticate, validate(listPurchaseOrdersSchema), procurementController.listPurchaseOrders);
